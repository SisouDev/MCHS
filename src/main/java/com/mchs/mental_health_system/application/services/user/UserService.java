...
public interface UserService {
    ...
    HealthProfessionalResponseDTO createHealthProfessional(UserCreationRequestDTO creationDTO);

    AdministrativeProfessionalResponseDTO createAdministrativeProfessional(UserCreationRequestDTO creationDTO);
